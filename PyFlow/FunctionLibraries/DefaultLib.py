...
class DefaultLib(FunctionLibraryBase):
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Bool, False), meta={'Category': 'Math|Bool', 'Keywords': [], "HeadColor" :Colors.Bool.lighter(50)})
    ## make boolean
    def makeBool(b=(DataTypes.Bool, False)):
        return b

    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Int, 0), meta={'Category': 'GenericTypes', 'Keywords': ["Int","Integer"], "HeadColor" :Colors.Int.lighter(50)})
    ## make integer
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Float, 0.0), meta={'Category': 'GenericTypes', 'Keywords': ["Float"], "HeadColor" :Colors.Float.lighter(50)})
    ...
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.String, ''), meta={'Category': 'GenericTypes', 'Keywords': ["String"], "HeadColor" : Colors.String.lighter(50)})
    ## make string
    ...
    # Conversions
    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Bool, False), meta={'Category': 'Conversion', 'Keywords': ["Bool"], "HeadColor" : Colors.Bool.lighter(50)})
    def toBool(i=(DataTypes.Any, 0,{"supportedDataTypes":[DataTypes.Bool,DataTypes.Float,DataTypes.Int]})):
        return bool(i)

    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Int, 0), meta={'Category': 'Conversion', 'Keywords': [], "HeadColor" : Colors.Int.lighter(50)})
    def toInt(i=(DataTypes.Any, 0,{"supportedDataTypes":[DataTypes.Bool,DataTypes.Float,DataTypes.Int]})):
        return int(f)

    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Float, False), meta={'Category': 'Conversion', 'Keywords': [],"HeadColor":Colors.Float.lighter(50)})
    def toFloat(i=(DataTypes.Any, 0,{"supportedDataTypes":[DataTypes.Bool,DataTypes.Float,DataTypes.Int]})):
        return float(i)

    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.String, ''), meta={'Category': 'Conversion', 'Keywords': [],"HeadColor":Colors.String.lighter(50)})
    def toString(i=(DataTypes.Any, 0)):
        return str(i)

    @staticmethod
    @IMPLEMENT_NODE(returns=(DataTypes.Any, 0,{"constraint":"1"}), meta={'Category': 'Conversion', 'Keywords': [],"HeadColor":Colors.Yellow.lighter(50)})
